...
public interface PostService extends ServiceInterface<PostCreateRequestDto, PostResponseDto, Long>{
    PostResponseDto add(PostCreateRequestDto requestDto, MultipartFile image);

    PostResponseDto update(PostCreateRequestDto requestDto, Long id, MultipartFile image);
}
